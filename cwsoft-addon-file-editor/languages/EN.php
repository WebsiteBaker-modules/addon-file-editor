...
$module_description = 'The cwsoft-addon-file-editor module allows you to edit text- and image files of installed Add-ons via the backend. For details see <a href="https://github.com/cwsoft/websitebaker-addon-file-editor-cwsoft-addon-file-editor#readme">GitHub</a>.';
